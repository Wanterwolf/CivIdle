export const KR = {
   ...
   AdvisorElectricityContent:
      "발전소는 두 가지 새로운 시스템을 제공합니다. 첫 번째인 '전력'은 발전소 주변의 번개 모양 타일로 표시됩니다. 일부 건물들(세계 대전에서 라디오부터 시작)은 입력 목록에 '전력 필요' 표시가 있습니다.<b>이는 해당 건물들이 작동하려면 반드시 번개 모양 타일 위에 지어져야 한다는 것을 의미합니다</b>. 전력이 필요하고 전력을 공급받는 건물들은 그 건물에 인접한 타일로도 전력을 전송합니다. 따라서 최소한 하나의 건물이 발전소에 닿아 있다면, 서로 간에 전력을 공급할 수 있습니다. <br><br>다른 시스템인 '전기화'는 과학이나 노동자를 생산하지 않는 한<b>지도상 어느 건물에나</b> 적용할 수 있습니다. 이는 발전소에서 생산된 전력을 사용하여 건물의 소비와 생산을 모두 증가시킵니다. 전기화 수준이 높아질수록 더 많은 양의 전력이 필요합니다. '전력 필요' 표시가 있는 건물을 전기화하는 것이 그렇지 않은 건물을 전기화하는 것보다 더 효율적입니다.",
   AdvisorElectricityTitle: "전력과 전기화",
   AdvisorGreatPeopleContent:
      "새로운 기술 시대에 진입할 때마다 해당 시대와 이전 시대의 위인들 중 한 명을 선택할 수 있습니다. 이 위인들은 생산, 과학, 행복도 등 다양한 분야에서 전역적인 보너스를 제공합니다.<br><br>이러한 보너스는 해당 환생 동안 영구적으로 유지됩니다. 환생할 때, 모든 위인들이 영구적으로 남게 되며, 그들의 보너스는 영원히 지속됩니다.<br><br>이후 게임에서 동일한 위인을 선택하면 영구 보너스와 현재 게임의 보너스가 중첩됩니다. 중복된 위인으로 환생할 경우, 추가 보너스는 저장되어 영구 보너스를 업그레이드하는 데 사용할 수 있습니다. 이는 본부 건물의 <b>영구 위인 관리</b> 메뉴에서 접근할 수 있습니다.",
   AdvisorGreatPeopleTitle: "위대한 인물들",
   AdvisorHappinessContent:
      "행복도는 CivIdle에서 확장을 제한하는 핵심 메커니즘입니다. 새로운 기술을 해금하거나, 새로운 시대로 진입하거나, 불가사의를 건설하거나, 행복도를 제공하는 위대한 인물들을 통해, 그리고 게임을 진행하면서 발견할 수 있는 몇 가지 다른 방법으로 행복도를 얻을 수 있습니다. <b>각 새로운 건물은 1의 행복도를 소비합니다</b>. 행복도가 0보다 높거나 낮을 때마다 총 노동자 수에 2%의 보너스 또는 페널티가 적용됩니다(행복도는 -50에서 +50 사이로 제한됩니다). <b>본부 건물의 행복도 섹션</b>에서 행복도에 대한 자세한 내역을 확인할 수 있습니다.",
   AdvisorHappinessTitle: "당신의 사람들을 행복하게 유지하세요.",
   AdvisorOkay: "알겠습니다, 감사합니다!",
   AdvisorScienceContent:
      "당신의 바쁜 노동자들은 과학을 생산하며, 이를 통해 새로운 기술을 해금하고 문명을 발전시킬 수 있습니다. 연구 메뉴에 접근하는 방법은 여러 가지가 있습니다. 과학 미터를 클릭하거나, 본부 건물에서 해금 가능한 기술에 접근하거나, '보기' 메뉴를 사용하면 됩니다. 이 모든 방법은 기술 트리로 이동하여 모든 기술과 각 기술에 필요한 과학 양을 보여줍니다. 새로운 기술을 배울 만큼 충분한 과학을 보유하고 있다면, 해당 기술을 클릭하고 사이드바 메뉴에서 '해금'을 누르기만 하면 됩니다. <b>각 새로운 단계와 기술 시대는 점점 더 많은 과학을 요구하지만, 동시에 과학을 얻을 수 있는 새롭고 더 나은 방법들도 해금하게 될 것입니다.</b>",
   AdvisorScienceTitle: "과학적 발견!",
   AdvisorSkipAllTutorials: "모든 튜토리얼 건너뛰기",
   AdvisorStorageContent:
      "건물들은 상당한 양의 저장 공간을 가지고 있지만, 특히 오랫동안 방치되면 가득 찰 수 있습니다. <b>건물이 가득 차면 더 이상 생산할 수 없습니다</b>. 건물이 가득 찼다는 것은 명백히 많은 재고가 있다는 의미이므로 항상 문제가 되는 것은 아닙니다. 하지만 일반적으로는 계속 생산을 유지하는 것이 더 좋습니다.<br><br>저장 공간이 가득 찬 문제를 해결하는 한 가지 방법은 창고를 이용하는 것입니다. 창고를 건설하면 발견한 모든 제품의 메뉴가 나타나며, 창고의 레벨과 저장 배수에 따라 가능한 총량 내에서 원하는 제품을 원하는 양만큼 가져오도록 설정할 수 있습니다.<br><br>창고를 쉽게 설정하는 방법은 창고로 가져오고 싶은 각 제품을 체크하고, '선택한 항목들 사이에 재분배' 버튼을 사용하여 수입률과 저장량을 균등하게 나누는 것입니다. 다른 건물들도 창고에서 제품을 가져갈 수 있게 하려면, '최대 양 이하일 때 내보내기' 옵션도 켜야 합니다.",
   AdvisorStorageTitle: "저장고와 창고",
   AdvisorTraditionContent:
      "일부 불가사의(초가 잔빌, 룩소르 신전, 빅벤)는 새로운 옵션 세트에 접근할 수 있게 해주어, 당신의 환생 경로를 커스터마이즈할 수 있게 합니다. 각각은 당신 문명의 전통, 종교, 이데올로기에 대해 4가지 옵션 중 하나를 선택할 수 있게 합니다.<br><br>하나를 선택하면 그 선택은 해당 환생 동안 고정되지만, 향후 환생에서는 다른 것을 선택할 수 있습니다. 선택한 후에는 필요한 자원을 제공하여 각각을 여러 번 업그레이드할 수 있습니다. 각 단계의 보상은 누적되므로, <b>1단계에서 X에 대한 생산력 +1을 주고 2단계에서 X에 대한 생산력 +1을 주면 2단계에서는 총 X에 대한 생산력 +2를 갖게 됩니다</b>.",
   AdvisorTraditionTitle: "경로 선택과 업그레이드 가능한 불가사의",
   AdvisorWonderContent:
      "불가사의는 게임플레이에 상당한 영향을 미칠 수 있는 전역적 효과를 제공하는 특별한 건물입니다. 나열된 기능 외에도 모든 불가사의는 +1의 행복도를 제공합니다. 하지만 주의해야 할 점은, <b>불가사의는 엄청난 양의 재료가 필요하고, 일반보다 높은 건설자 용량도 요구합니다</b>. 이는 필요한 투입 자원의 재고를 쉽게 소진시켜 다른 건물들이 자원 부족에 시달릴 수 있다는 뜻입니다. <b>각 투입 자원을 자유롭게 켜고 끌 수 있어</b>, 모든 것을 원활하게 유지하기에 충분한 재료를 비축하면서 단계적으로 건설할 수 있습니다.",
   AdvisorWonderTitle: "세계의 불가사의",
   AdvisorWorkerContent:
      "건물이 물품을 생산하거나 운송할 때마다 노동자가 필요합니다. 사용 가능한 노동자가 충분하지 않으면 일부 건물들이 해당 주기에 작동하지 않을 수 있습니다. 이에 대한 명확한 해결책은 노동자를 만드는 구조물(오두막/집/아파트/콘도)을 건설하거나 업그레이드하여 총 사용 가능한 노동자 수를 늘리는 것입니다.<br><br><b>하지만 건물이 업그레이드되는 동안에는 꺼져 있어 노동자를 포함한 어떤 자원도 제공할 수 없다는 점을 유의하세요. 따라서 한 번에 하나의 주거 건물만 업그레이드하는 것이 좋을 수 있습니다.</b> 게임 초기 단계에서는 전체 노동자의 약 70%가 바쁘게 일하도록 유지하는 것이 좋은 목표입니다. 70% 이상이 바쁘다면 주거시설을 업그레이드하거나 건설하세요. 70% 미만이 바쁘다면 생산을 확장하세요.",
   AdvisorWorkerTitle: "노동자 관리",
   Aeschylus: "아이스킬로스",
   Agamemnon: "아가멤논",
   AgeWisdomDescHTML: "각 시대 지혜의 레벨은 해당 시대의 <b>동등한 레벨</b>의 적격 영구 위인을 제공합니다 - 적격 영구 위인의 파편으로 업그레이드할 수 있습니다.",
   AgeWisdomGreatPeopleShardsNeeded: "다음 시대 지혜 업그레이드를 위해서는 %{amount}개의 위인 파편이 더 필요합니다",
   AgeWisdomGreatPeopleShardsSatisfied: "다음 시대 지혜 업그레이드를 위한 위인 파편이 충분합니다.",
   AgeWisdomNeedMoreGreatPeopleShards: "더 많은 위인 파편이 필요합니다.",
   AgeWisdomNotEligible: "이 위인은 시대 지혜에 적합하지 않습니다",
   AgeWisdomSource: "%{age} 지혜: %{person}",
   AgeWisdomUpgradeWarningHTML: "현재 당신의 계정 등급은 호민관입니다. 재무관으로 업그레이드할 때, 시대 지혜는 <b>이월될 수 없습니다</b>",
   AGreatPersonIsBorn: "위인이 태어났습니다.",
   AircraftCarrier: "항공 모함",
   AircraftCarrierYard: "항공 모함 조선소",
   Airplane: "비행기",
   AirplaneFactory: "비행기 공장",
   Akitu: "Akitu: 우르의 지구라트와 유프라테스 강은 현재 시대에 해금된 건물들에 적용됩니다",
   AlanTuring: "앨런 튜링",
   AlanTuringDesc: "쉬고 있는 노동자당 +%{value} 과학 생산",
   AlbertEinstein: "알베르트 아인슈타인",
   Alcohol: "알코올",
   AldersonDisk: "Alderson Disk",
   AldersonDiskDesc: "+25 행복도. 이 불가사의는 업그레이드할 수 있으며, 추가 업그레이드마다 +5 행복도를 제공합니다",
   Alloy: "합금",
   Alps: "알프스 산맥",
   ...
   AoiMatsuri: "Aoi Matsuri: 후지산이 워프를 두 배로 생성합니다",
   Apartment: "아파트",
   Aphrodite: "아프로디테",
   AphroditeDescV2: "20레벨 이상의 건물을 업그레이드할 때 각 레벨마다 +1 건설자 용량 배수를 제공합니다. 이번 실행에서 해금된 모든 고전 시대 영구 위인들의 레벨이 +1 증가합니다.",
   ...
   Beijing: "베이징",
   BigBen: "빅벤",
   BigBenDesc: "+2 과학을 바쁜 노동자로부터 얻습니다. 제국의 이데올로기를 선택하세요, 각 선택으로 더 많은 부스트를 해금합니다.",
   Biplane: "복엽기",
   ...
   Cleopatra: "클레오파트라",
   CloneFactory: "복제 공장",
   CloneFactoryDesc: "모든 자원을 복제",
   CloneFactoryInputDescHTML: "복제 공장은 <b>%{buildings}</b>에서 직접 운송된 <b>%{res}</b>만 복제할 수 있습니다",
   CloneLab: "복제 연구소",
   CloneLabDesc: "모든 자원을 과학으로 변환",
   CloneLabScienceMultiplierHTML: "<b>과학 생산 건물에만 적용되는</b> 생산 배수(예: 아토미움의 생산 배수)는 복제 연구소에 <b>적용되지 않습니다</b>",
   Cloth: "옷감",
   ...
   Colonialism: "식민주의",
   Colosseum: "콜로세움",
   ColosseumDescV2: "전차 공방은 -1 행복도 감소에서 제외됩니다. 10개의 전차를 소비하고 10의 행복도를 생산합니다. 해금된 각 시대마다 2의 추가 행복도를 제공합니다",
   ...
   Communism: "Communism",
   CommunismLevel4DescHTML: "<b>산업 시대</b>의 위인 한 명과 <b>세계 대전 시대</b>의 위인 한 명이 태어납니다",
   CommunismLevel5DescHTML: "<b>냉전 시대</b>의 위인 한 명이 태어납니다. 새로운 시대에 진입할 때, 해당 시대의 위인을 <b>2명 추가로</b> 얻습니다",
   ...
   Drilling: "시추",
   DukeOfZhou: "주문공",
   DynamicMultiplierTooltip: "이 배수는 동적입니다 - 노동자와 저장고에 영향을 미치지 않습니다",
   Dynamite: "다이너마이트",
   DynamiteWorkshop: "다이너마이트 공장",
   DysonSphere: "다이슨 구체",
   DysonSphereDesc: "모든 건물이 +5 생산 배수를 얻습니다. 이 불가사의는 업그레이드할 수 있으며, 추가 업그레이드마다 모든 건물에 +1 생산 배수를 제공합니다",
   Education: "교육",
   EiffelTower: "에펠탑",
   ...
   EuphratesRiverDesc:
   "생산에 참여하는(운송이 아닌) 바쁜 노동자 10%마다 노동자를 생산하지 않는 모든 건물에 +1 생산 배수를 제공합니다(최대 = 해금된 시대 수 / 2). 공중 정원이 옆에 건설되면, 공중 정원이 해금된 후 각 시대마다 +1 효과를 얻습니다. 발견 시, 매장물이 없는 모든 인접 타일에 물을 생성합니다",
   ...
   FeatureRequireQuaestorOrAbove: "이 기능은 Quaestor 등급 이상이 필요합니다",
   Festival: "축제",
   FestivalCycle: "축제 주기",
   FestivalTech: "축제 해금 - 긍정적인 행복도(최대 50)가 축제 포인트로 전환됩니다. 25 축제 포인트마다 당신의 제국은 축제 주기에 들어가며, 지도 특정 부스트를 크게 받습니다.",
   Feudalism: "봉건제",
   Fibonacci: "피보나치",
   ...
   FirstTimeTutorialWelcome: "CivIdle에 오신 것을 환영합니다.",
   FirstTimeTutorialWelcome1HTML:
      "CivIdle에 오신 것을 환영합니다. 이 게임에서 당신은 자신만의 제국을 운영하게 됩니다: <b>생산을 관리하고, 기술을 해금하며, 다른 플레이어들과 자원을 거래하고, 위인을 만들어내며 세계 불가사의를 건설합니다</b>.<br><br>마우스를 드래그하여 화면을 이동할 수 있습니다. 스크롤 휠을 사용하여 확대하거나 축소할 수 있습니다. 빈 타일을 클릭하여 새로운 건물을 지을 수 있고, 건물을 클릭하여 자세히 살펴볼 수 있습니다.<br><br>석재 채석장이나 벌목장 같은 특정 건물들은 자원 타일 위에 지어야 합니다. 안개 근처에 노동자를 제공하는 오두막을 배치하는 것을 추천합니다 - 건물을 짓는 데 시간이 걸릴 것입니다. 완성 후에는 주변의 안개를 밝힐 것입니다.",
   FirstTimeTutorialWelcome2HTML:
      "건물은 업그레이드할 수 있습니다 - 자원이 들고 시간이 걸립니다. 건물이 업그레이드되는 동안에는 <b>더 이상 생산하지 않습니다</b>. 이는 노동자를 제공하는 건물도 포함되므로, <b>절대로 모든 건물을 동시에 업그레이드하지 마세요!</b><br><br>제국이 성장함에 따라, 더 많은 과학을 얻고 새로운 기술을 해금하게 될 것입니다. 그 단계에 도달하면 더 자세히 설명해 드리겠지만, 지금 '보기 -> 연구'로 가서 간단히 살펴볼 수 있습니다<br><br>",
   FirstTimeTutorialWelcome3HTML: "이제 게임의 기본 사항을 모두 알게 되었으니, 당신의 제국을 건설하기 시작할 수 있습니다. 하지만 떠나보내기 전에, <b>플레이어 이름을 선택하고</b> 게임 내 채팅에서 인사를 나누는 것이 좋겠습니다. 우리는 매우 도움이 되는 커뮤니티를 가지고 있습니다: 길을 잃었다면 주저하지 말고 물어보세요!",
   Fish: "물고기",
   FishPond: "물고기 연못",
   ...
   GoldenPavilion: "금각사",
   GoldenPavilionDesc: "3타일 범위 내의 모든 건물은 소비하는 자원을 생산하는 인접 건물 하나당 +1 생산 배수를 얻습니다. (복제 연구소와 복제 공장은 제외되며, 해당 건물은 꺼질 수 없습니다.)",
   GoldMiningCamp: "금 광산",
   GordonMoore: "고든 무어",
   GrandBazaar: "그랜드 바자르",
   ...
   GreatPeopleFilter: "위대한 인물을 필터링하려면 이름이나 나이를 입력하세요.",
   GreatPeopleName: "이름",
   ...
   GreedyTransport: "건설/업그레이드 탐욕 운송",
   GreedyTransportDescHTML: "이 옵션을 선택하면 건물이 현재 업그레이드에 필요한 자원을 충분히 확보했더라도 계속해서 자원을 운송합니다. 이는 여러 단계의 업그레이드를 <b>더 빠르게</b> 할 수 있게 하지만 결과적으로 <b>필요 이상의 자원을 운송</b>하게 됩니다",
   GrottaAzzurra: "카프리 푸른 동굴",
   GrottaAzzurraDescV2: "발견 시, 당신의 모든 1단계 건물들이 +5 레벨과 +1 생산, 노동자 수용력, 저장 배수를 얻습니다.",
   Gunpowder: "화약",
   GunpowderMill: "화약 공장",
   HagiaSophia: "하기아 소피아",
   ...
   IdeologyDescHTML: "제국의 이념으로 <b>자유주의, 보수주의, 사회주의 또는 공산주의</b> 중에서 선택하세요. 선택 후에는 <b>이념을 바꿀 수 없습니다</b>. 각 이념 내에서 더 많은 부스트를 해금할 수 있습니다",
   IMPei: "I. M. 페이",
   ...
   InputResourceForCloning: "복제를 위한 입력 자원",
   InternationalSpaceStation: "국제 우주 정거장",
   InternationalSpaceStationDesc: "모든 건물이 +5 저장 배수를 얻습니다. 이 불가사의는 업그레이드할 수 있으며 추가 업그레이드마다 모든 건물에 +1 저장 배수를 제공합니다",
   Internet: "인터넷",
   ...
   ItsukushimaShrineDescV2: "한 시대의 모든 기술이 해금되면, 다음 시대에서 가장 저렴한 기술의 비용과 동일한 일회성 과학을 생성합니다.",
   JamesWatson: "제임스 왓슨",
   ...
   Kanagawa: "가나가와",
   KanagawaDesc: "이번 실행에서 현재 시대의 모든 위인들이 추가 레벨을 얻습니다. (제노비아 제외)",
   KarlMarx: "카를 마르크스",
   Knight: "기사",
   KnightCamp: "기사 야영지",
   Kyoto: "교토",
   LandTrade: "토지 매매",
   Language: "언어",
   LargeHadronCollider: "대형 강입자 충돌기",
   LargeHadronColliderDescV2: "이번 실행에서 모든 정보 시대 위인들이 +2 레벨을 얻습니다. 이 불가사의는 업그레이드할 수 있으며, 추가 업그레이드마다 이번 실행에서 모든 정보 시대 위인들에게 +1 레벨을 제공합니다.",
   Law: "법",
   Lens: "안경",
   LensWorkshop: "안경 공장",
   ...
   LevelX: "레벨 %{level}",
   Liberalism: "자유주의",
   LiberalismLevel3DescHTML: "창고 <b>에서</b> 그리고 창고 <b>로의</b> 무료 운송",
   LiberalismLevel5DescHTML: "전기화 효과 <b>두 배</b>",
   ...
   Lumber: "목재",
   LumberMill: "제재소",
   LunarNewYear: "Lunar New Year: 만리장성이 건물들에 두 배의 부스트를 제공합니다. 도자기탑은 이번 실행에서 모든 위인들에게 +1 레벨을 제공합니다",
   LuxorTemple: "룩소르 신전",
   ...
   Maglev: "자기부상열차",
   MaglevFactory: "자기부상열차 공장",
   MahatmaGandhi: "마하트마 간디",
   ManageAgeWisdom: "시대 지혜 관리",
   ManagedImport: "자동 운송",
   ...
   MarinaBaySandsDesc: "모든 건물이 +5 노동자 수용력 배수를 얻습니다. 이 불가사의는 업그레이드할 수 있으며 추가 업그레이드마다 모든 건물에 +1 노동자 수용력 배수를 제공합니다",
   Market: "시장",
   ...
   MarketYouPay: "지불",
   MartinLuther: "마틴 루터",
   MaryamMirzakhani: "마리암 미르자하니",
   MaryamMirzakhaniDesc: "유휴 노동자로부터 +%{value} 과학",
   Masonry: "벽돌",
   MatrioshkaBrain: "마트료시카 브레인",
   MatrioshkaBrainDescV2: "제국 가치 계산 시 과학을 포함시킵니다 (5 과학 = 1 제국 가치). 바쁜 노동자와 유휴 노동자당 +5 과학. 이 불가사의는 업그레이드할 수 있으며 추가 업그레이드마다 바쁜 노동자와 유휴 노동자당 +1 과학을 제공하고 과학을 생산하는 건물에 +1 생산 배수를 제공합니다",
   ...
   MotionPicture: "영화",
   MountFuji: "후지산",
   MountFujiDescV2: "페트라가 그 옆에 건설되면, 페트라는 +8시간의 워프 저장소를 얻습니다. 게임이 실행 중일 때, 페트라에서 매분 20 워프를 생성합니다 (페트라 자체에 의해 가속되지 않으며, 게임이 오프라인일 때는 생성되지 않습니다)",
   MountSinai: "시나이 산",
   ...
   MoveBuildingSelectTileToastHTML: "<b>탐험된 빈 타일</b>을 지도에서 목표로 선택하세요",
   Movie: "영화",
   MovieStudio: "영화관",
   Museum: "박물관",
   Music: "음악",
   ...
   Opet: "Opet: 대스핑크스가 더 이상 소비 배수를 증가시키지 않습니다",
   OpticalFiber: "광섬유",
   ...
   OsakaCastle: "오사카 성",
   OsakaCastleDesc: "2타일 범위 내의 모든 타일에 전력을 제공합니다. 과학 생산 건물의 전기화를 허용합니다(복제 연구소 포함)",
   ...
   Painting: "그림",
   PalmJumeirah: "팜 주메이라",
   PalmJumeirahDesc: "+10 건설자 수용력. 이 불가사의는 업그레이드할 수 있으며 추가 업그레이드마다 +2 건설자 수용력을 제공합니다",
   Panathenaea: "파나테나이아: 포세이돈이 모든 건물에 +1 생산 배수를 제공합니다",
   Pantheon: "판테온",
   ...
   Peace: "평화",
   Peacekeeper: "평화유지군",
   PercentageOfProductionWorkers: "생산 노동자 비율",
   Performance: "성능",
   PermanentGreatPeople: "영구적인 위인",
   PermanentGreatPeopleAcquired: "영구적인 위인 획득",
   PermanentGreatPeopleLevels: "영구적인 위인 레벨",
   PermanentGreatPeopleUpgradeUndo: "영구 위인 업그레이드 취소: 이는 업그레이드된 레벨을 파편으로 되돌립니다 - %{amount}개의 파편을 얻게 됩니다",
   Persepolis: "페르세폴리스",
   PersepolisDesc: "모든 벌목장, 채석장, 구리광산이 +1의 생산, 저장소, 노동자 능력 배수를 얻습니다.",
   PeterHiggs: "피터 힉스",
   PeterHiggsDesc: "바쁜 노동자로부터 +%{value} 과학",
   Petra: "페트라",
   ...
   PlayerTradeNoFillBecauseOfResources: "자원 부족으로 인해 거래가 성사되지 않았습니다",
   ...
   PorcelainTowerMaxPickPerRoll: "롤당 최대 선택 선호",
   PorcelainTowerMaxPickPerRollDescHTML: "도자기탑 완성 후 위인을 선택할 때, 사용 가능한 양에 대해 롤당 최대 선택을 선호합니다",
   Poseidon: "포세이돈",
   PoseidonDescV2: "인접한 모든 건물이 25레벨까지 무료 업그레이드를 받고 +N 생산, 노동자 수용력, 저장 배수를 얻습니다. N = 건물의 등급",
   PoultryFarm: "가금류 농장",
   Power: "전력",
   ...
   RandomColorScheme: "랜덤 색상 스킴",
   RapidFire: "속사",
   ReadFullPatchNotes: "패치 노트 확인(영문)",
   Reborn: "환생",
   RebornCity: "새로운 도시 선택",
   RebornModalDescV3: "새로운 제국을 시작하게 되지만 <b>이번 실행에서의</b> 모든 위인들이 영구적인 파편이 되어, <b>영구 위인 레벨</b>을 업그레이드하는 데 사용할 수 있습니다. 또한 <b>총 제국 가치</b>에 따라 추가 위인 파편을 얻게 됩니다.",
   ...
   RequiredWorkersTooltipV2: "생산에 필요한 노동자 수는 모든 자원의 소비량과 생산량을 배수 적용 후 합산한 값과 같습니다. (동적 배수는 제외)",
   ...
   ResourceCloneTooltip: "생산 배수는 복제된 자원(즉, 추가 복사본)에만 적용됩니다.",
   ResourceColor: "자원 색상",
   ...
   ResourceImportPartialWarningHTML: "총 자원 운송 용량이 최대 용량을 초과했습니다: <b>각 자원 운송은 주기마다 부분적으로만 운송될 것입니다.</b>",
   ...
   Saturnalia: "사투르날리아: 알프스가 더 이상 소비 배수를 증가시키지 않습니다",
   SaveAndExit: "저장 후 종료",
   School: "학교",
   Science: "과학",
   ...
   ShowTransportArrowDescHTML: "이 옵션을 끄면 운송 화살표가 숨겨집니다. 저사양 기기에서 성능을 <i>약간</i> 개선할 수 있습니다. 성능 개선은 <b>게임을 다시 시작한 후</b> 적용됩니다",
   ...
   Skyscraper: "마천루",
   Socialism: "사회주의",
   SocialismLevel4DescHTMLV2: "가장 저렴한 <b>세계 대전 시대</b> 기술 비용에 해당하는 일회성 과학을 생성합니다",
   SocialismLevel5DescHTMLV2: "가장 저렴한 <b>냉전 시대</b> 기술 비용에 해당하는 일회성 과학을 생성합니다",
   ...
   SupporterThankYou: "CivIdle는 다음 서포터 팩 소유자들의 관대함 덕분에 유지되고 있습니다",
   Sword: "검",
   SwordForge: "검 대장간",
   ...
   Thanksgiving: "추수감사절: 월스트리트가 건물에 두 배의 부스트를 제공하며 뮤추얼 펀드, 헤지 펀드, 비트코인 채굴기에 적용됩니다. 연구 기금은 +5 생산 배수를 얻습니다",
   Theater: "극장",
   Theme: "테마",
   ThemeColor: "테마 색상",
   ...
   TotalEmpireValuePerWallSecond: "실제 시간 초당 총 제국 가치",
   TotalEmpireValuePerWallSecondPerGreatPeopleLevel: "위인 레벨 당 실제 시간 초당 총 제국 가치",
   TotalGameTimeThisRun: "이번 실행의 총 게임 시간",
   TotalScienceRequired: "총 과학 요구량",
   TotalStorage: "총 저장량",
   TotalWallTimeThisRun: "이번 실행의 총 실제 시간",
   TotalWallTimeThisRunTooltip: "실제 시간(즉, 경과된 실제 시간)은 이번 실행에 걸린 실제 시간을 측정합니다. 이는 게임 시간과 다르며, 페트라의 시간 왜곡과 오프라인 생산은 실제 시간에 영향을 주지 않지만 게임 시간에는 영향을 줍니다",
   TotalWorkers: "총 노동자",
   TowerOfBabel: "바벨탑",
   TowerOfBabelDesc: "불가사의에 인접한 곳에 최소 한 개의 작동 중인 건물이 있는 모든 건물에 +2 생산 배수를 제공합니다",
   ...
   TransportPlanCache: "운송 계획 캐시",
   TransportPlanCacheDescHTML:
   "매 주기마다 각 건물은 설정에 따라 최적의 운송 계획을 계산합니다 - 이 과정은 높은 CPU 성능을 필요로 합니다. 이 기능을 활성화하면 운송 계획의 결과가 여전히 유효할 경우 캐시를 시도하여 CPU 사용량과 프레임 속도 저하를 줄일 수 있습니다. <b>실험적 기능</b>",
   ...
   "온라인 <b>선택적</b> 기능에 참여할 계획이 없다면 Tribune으로 전체 게임을 플레이할 수 있습니다. 온라인 기능에 대한 제한 없는 액세스를 얻으려면 Quaestor로 업그레이드해야 합니다. <b>이는 게임을 모두에게 무료로 유지하기 위한 봇 방지 조치입니다.</b> 하지만, <b>Quaestor로 업그레이드할 때</b> 다음과 같이 위인을 이월할 수 있습니다: <ul><li>청동기, 철기 및 고전 시대는 최대 <b>3</b> 레벨까지</li><li>중세, 르네상스 및 산업 시대는 최대 <b>2</b> 레벨까지</li><li>세계 대전, 냉전 및 정보 시대는 최대 <b>1</b> 레벨까지</li></ul>해당 레벨을 초과하는 위인의 파편과 <b>시대의 지혜</b> 레벨은 <b>이월할 수 없습니다</b>",
   ...
   Vineyard: "포도밭",
   VirtualReality: "가상현실",
   WallOfBabylon: "바빌론의 벽",
   WallOfBabylonDesc: "모든 건물이 +N 저장 배수를 얻습니다. N = 잠금 해제된 시대의 수 / 2",
   WallStreet: "월스트리트",
   ...
   ZagrosMountainsDesc: "인접한 모든 건물 중 생산 배수가 5 미만인 건물에 +2 생산 배수를 제공합니다. 네부카드네자르 2세(위인)의 효과를 두 배로 증가시킵니다",
   ZahaHadid: "자하 하디드",
   ZahaHadidDesc: "+%{value} 건설자 용량 배수",
   Zenobia: "제노비아",
   ZenobiaDesc: "페트라 워프 최대치 +%{value} 시간",
   ZhengHe: "정화",
   ZigguratOfUr: "우르의 지구라트",
   ZigguratOfUrDescV2: "10의 행복도마다(상한 적용) 노동자를 생산하지 않고 이전 시대에 잠금 해제된 모든 건물에 +1 생산 배수를 제공합니다(최대 = 잠금 해제된 시대 수 / 2). 불가사의(자연 불가사의 포함)는 더 이상 +1 행복도를 제공하지 않습니다. 이 효과는 끌 수 있습니다",
   Zoroaster: "조로아스터",
};
